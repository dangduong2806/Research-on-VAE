...
class Encoder(nn.Module):
    def __init__(self, latent_features: int, in_channels: int = 1):
        super(Encoder, self).__init__()
        self.latent_features = latent_features
        self.conv0 = nn.Conv2d(in_channels=in_channels, out_channels=32, kernel_size=3, stride=1, padding=1)
...
class Decoder(nn.Module):
    def __init__(self, latent_features: int, in_channels: int = 1):
        ...
        self.conv6 = nn.Conv2d(in_channels=32, out_channels=in_channels, kernel_size=3, stride=1, 
                                        padding=1)
...
class CIFAR_VAE(nn.Module):
    def __init__(self, latent_features: int, in_channels: int):
        ...
        self.encoder = Encoder(latent_features=latent_features, in_channels=in_channels)
        self.decoder = Decoder(latent_features=latent_features, in_channels=in_channels)
